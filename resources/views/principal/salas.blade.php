        ...
        <div class="col-sm-6 col-lg-3">
            <a href="{!!URL::to('/salas/sala-A')!!}" class="thumbnail">
                ...
                <div class="hidden-xs hidden-sm hidden-md texto-salas">
                    ...
                    <p><b>Bajo</b>: cabezal Marshall 3530, Marshall 1X15” y 4X10”</p>
                    <p><b>Bateria</b>: Pearl Export ProSeries 6 cuerpos año `96 Medidas: 22”,16”,14”,12”,10”. Tambor 14”</p>
                </div>
            </a>
        </div>
        <div class="col-xs-12 col-sm-6 col-lg-3">
            <a href="{!!URL::to('/salas/sala-B')!!}" class="thumbnail">
                ...
                <div class="hidden-xs hidden-sm hidden-md texto-salas">
                    ...
                    <p><b>Bajo</b>: cabezal: Marshall 8400 Dynamic bass, Marshall 2x15” Dynamic bass system</p>
                    <p><b>Bateria</b>: Pearl Export Series EX 5 cuerpos, Medidas: 22”,16”,13”,12”. Tambor 14” madera</p>
                </div>
            </a>
        </div>
        <div class="col-xs-12 col-sm-6 col-lg-3">
            <a href="{!!URL::to('/salas/sala-C')!!}" class="thumbnail">
                ...
                <div class="hidden-xs hidden-sm hidden-md texto-salas">
                    ...
                    <p><b>Bajo</b>: cabezal Peavey mark III bass xp series USA, Electro Voice 2x15” USA</p>
                    <p><b>Bateria</b>: Pearl Export Series año 92 tilo 6 cuerpos, Medidas: 22”,18”,16”,13”,12”. Tambor 14”</p>
                </div>
            </a>
        </div>
        <div class="col-xs-12 col-sm-6 col-lg-3">
            <a href="{!!URL::to('/salas/sala-D')!!}" class="thumbnail">
                ...
                <div class="hidden-xs hidden-sm hidden-md texto-salas">
                    ...
                    <p><b>Bajo</b>: Cabezal Peavey Mark III bass xp series USA,Electro Voice 2 x 15” USA</p>
                    <p><b>Bateria</b>: Pearl Export Series año 90 tilo 6 cuerpos, 22”,16”,14”,13”,12”. Tambor 14”</p>
                </div>
            </a>
        </div>
        </div>
